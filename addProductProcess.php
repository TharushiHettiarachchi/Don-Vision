...
if (isset($_FILES["image1"])) {
    ...
    if (!in_array($file_ex, $allowed_image_extentions)) {
        ...
        Database::iud("INSERT INTO `product_images`(`code`,`product_id`) VALUES('".$file_name1."','".$title."')");
    }
}
...
Database::iud("INSERT INTO `product`(`id`,`price`,`qty`,`category_id`,`sub_title`,`brand_id`) VALUES('".$title."','".$price."','".$qty."','".$category."','".$subTitle."','".$brand."')");
