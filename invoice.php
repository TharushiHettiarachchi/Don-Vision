...
<body>
    <div class="invoiceDiv0">
        <button onclick="saveInvoice();" style="width:5%; background-color: blue; color:white;">Submit</button>
    </div>
    <div class="invoiceDiv1" id="page">
        ...
        <div class="invoiceDiv12">
            <div class="invoiceDiv13">
                ...
                <input type="date" class="invoiceInput1" id="order_date"/>
            </div>
            <div class="invoiceDiv13">
                <label class="invoiceLabel2">Order ID</label>
                <input type="text" class="invoiceInput1" id="order_id"/>
            </div>
        </div>
        <div class="invoiceDiv12">
            <div class="invoiceDiv14">
                <label class="invoiceLabel3">Customer Name</label>
                <input type="text" class="invoiceInput2" id="name"/>
            </div>
        ...
        <div class="invoiceDiv12">
            <div class="invoiceDiv14">
                ...
                <input type="text" class="invoiceInput2" id="address"/>
            </div>
        ...
        <div class="invoiceDiv12">
            <div class="invoiceDiv14">
                ...
                <input type="text" class="invoiceInput2" id="mobile"/>
            </div>
        ...
        <div class="invoiceDiv17">
            ...
            <input type="text" class="invoiceLabel4" id="r_sph"/>
            <input type="text" class="invoiceLabel4" id="r_cyl"/>
            <input type="text" class="invoiceLabel4" id="r_axis"/>
            <input type="text" class="invoiceLabel4" id="r_add"/>

        </div>
        <div class="invoiceDiv17">
            <label class="invoiceLabel4">L/E</label>
            <input type="text" class="invoiceLabel4" />
            <input type="text" class="invoiceLabel4" id="l_sph" />
            <input type="text" class="invoiceLabel4" id="l_cyl"/>
            <input type="text" class="invoiceLabel4" id="l_axis"/>
            <input type="text" class="invoiceLabel4" id="l_add"/>

        </div>
        <div class="invoiceDiv12">
            <div class="invoiceDiv13">
                <label class="invoiceLabel5">PD</label>
                <input type="text" class="invoiceInput1" id="pd" />
            </div>
            <div class="invoiceDiv13">
                <label class="invoiceLabel5">SH</label>
                <input type="text" class="invoiceInput1" id="sh"/>
            </div>
        </div>
        <div class="invoiceDiv20">
            <label class="invoiceLabel3">Remarks</label>
            <textarea class="invoiceInput2" rows="3" cols="40" id="remarks"></textarea>
        </div>
        <div class="invoiceDiv12">
            <div class="invoiceDiv13">
                <label class="invoiceLabel2">Lens</label>
                <input type="text" class="invoiceInput1" id="lens"/>
            </div>
            <div class="invoiceDiv13">
                <label class="invoiceLabel2">Frame</label>
                <input type="text" class="invoiceInput1" id="frame"/>
            </div>
        </div>
        <div class="invoiceDiv21">
            <div class="invoiceDiv22">
                <label class="invoiceLabel6">Frame :</label>
                <input type="text" class="invoiceInput5" id="frame_price"/>

            </div>
            <div class="invoiceDiv22">
                <label class="invoiceLabel6">Lens :</label>
                <input type="text" class="invoiceInput5" id="lens_price"/>

            </div>

            <div class="invoiceDiv22">
                <label class="invoiceLabel6">Other :</label>
                <input type="text" class="invoiceInput5" id="other"/>

            </div>

            <div class="invoiceDiv22">
                <label class="invoiceLabel6">AMOUNT :</label>
                <input type="text" class="invoiceInput5" id="amount"/>

            </div>

            <div class="invoiceDiv22">
                <label class="invoiceLabel6">Discount :</label>
                <input type="text" class="invoiceInput5" id="discount" />

            </div>

            <div class="invoiceDiv22">
                <label class="invoiceLabel6">TOTAL AMOUNT :</label>
                <input type="text" class="invoiceInput5" id="total"/>

            </div>

            <div class="invoiceDiv22">
                <label class="invoiceLabel6">Advance :</label>
                <input type="text" class="invoiceInput5" id="advance"/>

            </div>

            <div class="invoiceDiv22">
                <label class="invoiceLabel6">BALANCE :</label>
                <input type="text" class="invoiceInput5" id="balance"/>
